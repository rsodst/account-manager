...
{
    public class SignUpHandler : IRequestHandler<SignUpCommand, UserToken>
    {
        private readonly IJwtTokenService _jwtTokenService;
        private readonly UserManager<ApplicationUser> _userManager;

        public SignUpHandler(IJwtTokenService jwtTokenService, UserManager<ApplicationUser> userManager)
        {
